Feature: Parking allocation
  ...
  Scenario Outline: Parking via mobile phone
    ...
    Examples:
        ...
        | Tamme puiestee 1 | yes (balance 12.5 euro) | Vanemuise      | hourly          | 15:00             | 17:00           | parking space for 20 mins is booked and your fee is 2 euros |
        ...
        | Tamme puiestee 1 | yes (balance 12.5 euro) | Vaksali        | real time       | 17:43             | 180 minutes     | parking space with real time is booked and your fee will be sent at the end of month (fee shown at the end of month: 12.82) |
